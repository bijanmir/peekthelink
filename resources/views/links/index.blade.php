<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($links->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
                    <!-- Total Links -->
                    <div class="metric-card glass-card rounded-2xl p-6 border border-blue-200 slide-up" style="animation-delay: 0.1s">
                    ...
                    <!-- Active Links -->
                    <div class="metric-card glass-card rounded-2xl p-6 border border-emerald-200 slide-up" style="animation-delay: 0.2s">
                        <div class="flex items-center justify-between">
                            <div>
                    ...
                    <!-- Total Clicks -->
                    <div class="metric-card glass-card rounded-2xl p-6 border border-purple-200 slide-up" style="animation-delay: 0.3s">
                        <div class="flex items-center justify-between">
                            <div>
                    ...
                    <!-- Performance Score -->
                    <div class="metric-card glass-card rounded-2xl p-6 border border-orange-200 slide-up" style="animation-delay: 0.4s">
                        <div class="flex items-center justify-between">
                            <div>
            ...
            @if($links->count() > 0)
                <div class="glass-card rounded-2xl p-4 sm:p-6 mb-8 border border-white/20 slide-up" style="animation-delay: 0.5s">
            ...
            <div class="glass-card rounded-2xl shadow-xl border border-white/20 slide-up" style="animation-delay: 0.6s">
                    ...
                    @if($links->count() > 0)
                        <div id="links-container" class="space-y-4">
                            @foreach($links as $link)
                                <div class="link-item bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-blue-300 rounded-2xl p-6 sm:p-6 transition-all duration-300 cursor-move shadow-sm hover:shadow-lg mb-4 sm:mb-0" 
                                     data-id="{{ $link->id }}" 
                                        ...
                                        <div class="flex items-start justify-between mb-4">
                                            ...
                                            <div class="flex items-center space-x-4 flex-1 min-w-0">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    @if(($link->link_type ?? 'regular') !== 'regular')
                                                        <div class="absolute -top-2 -right-2 revenue-badge text-xs font-bold text-white px-2 py-1 rounded-full">
                                                            {{ ucfirst($link->link_type ?? 'regular') }}
                                                        </div>
                                                    @endif
                                                </div>
                                                    ...
                                                    <div class="px-4 py-3 text-sm border-t border-gray-100">
                                                        <div class="flex justify-between items-center">
                                                            ...
                                                            <span class="text-green-600 font-bold text-lg">
                                                                @if($link->link_type === 'sponsored')
                                                                    ${{ number_format(($link->sponsored_rate ?? 0) * $link->clicks, 2) }}
                                    ...
                                    <div class="hidden sm:flex items-center justify-between">
                                        <div class="flex items-center flex-1 min-w-0">
                                            ...
                                            {{-- Enhanced Link Icon with Revenue Indicator --}}
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize drag and drop first
