...
<head>
    ...
    <meta name="description"
        content="{{ $description ?? 'Create beautiful link-in-bio pages with PeekTheLink. Share all your important links in one stunning, mobile-optimized landing page.' }}">
    <meta name="keywords"
        content="{{ $keywords ?? 'link in bio, social media links, landing page, linktree alternative' }}">
    ...
    <meta property="og:description"
        content="{{ $description ?? 'Create beautiful link-in-bio pages with PeekTheLink.' }}">
