...
<head>
    ...
    <title>PeekTheLink - Premium Login</title>
...
<body class="overflow-hidden">
                ...
                <div class="premium-border rounded-2xl p-8 glass-effect">
                    <form id="loginForm" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input id="email" 
                                       ...
                                       class="block w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:border-indigo-500 input-glow transition-all duration-300 text-lg font-medium bg-white/50 backdrop-blur-sm"
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input id="password" 
                                       ...
                                       class="block w-full pl-12 pr-12 py-4 border-2 border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:border-indigo-500 input-glow transition-all duration-300 text-lg font-medium bg-white/50 backdrop-blur-sm"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 transition duration-200 relative group" onclick="showForgotPassword()">
                                    Reset password
                        ...
                        <div id="loginStatus" class="hidden p-4 rounded-lg text-sm font-medium"></div>
                        ...
                        <div>
                            <button type="submit" 
                                ...
                                <span id="buttonText" class="relative z-10">Access PeekTheLink Pro</span>
                            </button>
                        </div>
                        ...
                        <div class="text-center pt-4">
                            <p class="text-sm text-gray-600">
                                ...
                                <a onclick="goToStartYourFreeTrial()" class="cursor-pointer font-semibold text-indigo-600 hover:text-indigo-500 transition duration-200 relative group ml-1">
    ...
    <script>
        ...
        const demoUsers = [
            { email: 'demo@peekthelink.com', password: 'demo123' },
            { email: 'admin@peekthelink.com', password: 'admin123' },
            { email: 'test@peekthelink.com', password: 'test123' }
        ];
        ...
        function showForgotPassword() {
            showStatus('info', '🔗 Password reset link sent! Check your email for instructions.');
        }

        // Show status messages
        function showStatus(type, message) {
            const status = document.getElementById('loginStatus');
            status.classList.remove('hidden', 'bg-red-50', 'text-red-600', 'bg-green-50', 'text-green-600', 'bg-blue-50', 'text-blue-600');
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                if (user) {
                    // Success
                    showStatus('success', '🎉 Welcome back! Redirecting to your dashboard...');
                    buttonText.textContent = 'Success!';
                    
                    setTimeout(() => {
                        alert('🚀 Login successful! In a real app, you would now be redirected to your PeekTheLink dashboard with all your links and analytics.');
                        buttonText.textContent = originalText;
                        button.disabled = false;
                    }, 2000);
                } else {
                    // Failed login
                    showStatus('error', '❌ Invalid email or password. Please try again.');
                    showError('email', 'Check your credentials and try again.');
                    showError('password', 'Check your credentials and try again.');
                    
                    // Show demo credentials hint
                    setTimeout(() => {
                        showStatus('info', '💡 Demo: Try demo@peekthelink.com / demo123');
                    }, 3000);
