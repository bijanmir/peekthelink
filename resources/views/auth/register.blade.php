...
<head>
    ...
    <title>Join PeekTheLink - Premium Registration</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-x-hidden">
        ...
        <header class="flex-shrink-0 p-4 sm:p-6">
            <div class="flex items-center justify-between max-w-6xl mx-auto">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-2xl font-bold gradient-text">PeekTheLink</span>
                </div>
                <a href="{{ route('login') }}" class="text-gray-600 hover:text-purple-600 font-medium transition-colors duration-200">
            ...
            <div class="w-full max-w-md">
                ...
                <div id="step1" class="form-step">
                    ...
                    <div class="text-center step-header slide-up">
                        <div class="w-16 h-16 professional-card rounded-2xl mx-auto mb-4 flex items-center justify-center enhanced-glow">
                            <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                            </svg>
                        </div>
                        <h1 class="text-3xl font-bold gradient-text mb-2">Join PeekTheLink</h1>
                        <p class="text-gray-600 font-medium">Create your professional presence in minutes</p>
                    </div>

                    <!-- Registration Form -->
                    <div class="professional-card rounded-2xl p-6 shadow-2xl slide-up stagger-1">
                        <form id="registrationForm" class="space-y-4">
                            ...
                            <div class="form-field">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="fullName" type="text" required 
                                           class="premium-input w-full pl-10 pr-4 py-3 rounded-xl focus:outline-none text-base"
                            ...
                            <div class="form-field">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="username" type="text" required 
                                           class="premium-input w-full pl-10 pr-10 py-3 rounded-xl focus:outline-none text-base"
                            ...
                            <!-- Terms Checkbox -->
                            <div class="form-field">
                                <div class="professional-card rounded-xl p-4 bg-gradient-to-r from-purple-50/80 to-blue-50/80">
                            ...
                            <!-- Submit Button -->
                            <button type="submit" 
                                    class="w-full premium-button text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center text-base enhanced-glow">
                            ...
                            <!-- Security Note -->
                            <div class="flex items-center justify-center text-xs text-gray-500 space-x-2 professional-card rounded-lg p-3">
                                <svg class="w-4 h-4 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span class="font-medium">256-bit SSL encrypted • Free forever • No ads</span>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div id="step2" class="form-step hidden">
                    <div class="text-center slide-up">
                        <div class="w-20 h-20 professional-card rounded-full mx-auto mb-6 flex items-center justify-center enhanced-glow">
                            <svg class="h-10 w-10 text-emerald-600 success-checkmark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path>
                            </svg>
                        </div>
                        
                        <h1 class="text-4xl font-bold gradient-text mb-3">Welcome to PeekTheLink!</h1>
                        <p class="text-gray-600 text-lg font-medium mb-8">Your account has been created successfully</p>
                        
                        <div class="professional-card rounded-2xl p-6 shadow-2xl">
                            <h3 class="text-xl font-bold text-gray-800 mb-4">Your PeekTheLink is ready!</h3>
                            <div class="professional-card rounded-xl p-4 mb-6 bg-gradient-to-r from-emerald-50/80 to-green-50/80">
                                ...
                                <p class="text-lg font-bold text-emerald-600" id="finalUrl">peekthelink.com/username</p>
                            </div>
                            
                            <div class="space-y-3">
                                <button onclick="goToDashboard()" class="w-full premium-button text-white font-bold py-3 px-6 rounded-xl enhanced-glow">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                    </svg>
                                    Go to Dashboard
                                </button>
                                <button onclick="copyUrl()" class="w-full professional-card hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-xl transition-colors">
